...
role: 
version: 1.0
location: /xkagent_infra/groups/system/agents/agent-system_dashboard_test_engineer
scope: /xkagent_infra/groups/system
---

# agent-system_dashboard_test_engineer 配置

## 职责定位

**我是 `/xkagent_infra/groups/system` 项目组的 custom Agent**。

```yaml
scope:
  project_group: /xkagent_infra/groups/system
  agent_name: agent-system_dashboard_test_engineer
  role: custom
```
