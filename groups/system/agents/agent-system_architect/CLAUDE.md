---
role: system 的 architect Agent
version: 1.0
location: /xkagent_infra/groups/system/agents/agent-system_architect
scope: /brain/groups/org/system
---

# agent-system_architect 配置

## 职责定位

**我是 `/brain/groups/org/system` 项目组的 architect Agent**。

```yaml
scope:
  project_group: /brain/groups/org/system
  agent_name: agent-system_architect
  role: architect
```
