...
role: 
version: 1.0
location: /xkagent_infra/groups/system/agents/agent-system_dashboard_researcher
scope: /xkagent_infra/groups/system
---

# agent-system_dashboard_researcher 配置
...
scope:
  ...
  agent_name: agent-system_dashboard_researcher
  role: custom
```
