...
declare -x CODEX_HOME="/xkagent_infra/groups/system/agents/agent-system_dashboard_researcher/.codex"
...
declare -x PATH="/xkagent_infra/groups/system/agents/agent-system_dashboard_researcher/.codex/tmp/arg0/codex-arg0GDTvN5:/usr/lib/node_modules/@openai/codex/node_modules/@openai/codex-linux-x64/vendor/x86_64-unknown-linux-musl/path:/root/.local/bin:/opt/venv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/xkagent_infra/brain/bin:/xkagent_infra/brain/bin:/brain/bin"
...
declare -x TMUX="/tmp/tmux-0/default,22341,21"
declare -x TMUX_PANE="%21"
declare -x TMUX_SESSION="agent-system_dashboard_researcher"
