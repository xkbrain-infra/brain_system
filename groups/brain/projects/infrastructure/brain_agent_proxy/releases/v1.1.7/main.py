...
MODEL_CONTEXT_WINDOWS: Dict[str, int] = {
    ...
    "claude-opus-4.5": 160000,
    "claude-opus-4-6": 192000,
    "claude-opus-4.6": 192000,
    "claude-haiku-4-5": 160000,
    "claude-haiku-4.5": 160000,
    "claude-haiku-4-5-20251001": 160000,
    # MiniMax
    "MiniMax-M2.5": 204800,
...
def _get_model_context_window(model_id: str) -> Optional[int]:
...
def _append_model_entries(
    ...
    *,
    ...
    for exposed_id in _build_exposed_model_ids(model_id, provider_id):
        ...
        ctx_win = _get_model_context_window(model_id)
...
async def _anthropic_message_to_sse(message: Dict[str, Any]):
    ...
    _ctx_win = _get_model_context_window(model)
...
async def _openai_sse_to_anthropic_sse(
    ...
    async def _emit_message_start(input_tokens: int = 0):
        ...
        _cw = _get_model_context_window(model)
        if _cw is not None:
