...
def scan_ipc_logs(log_dir: str = "/xkagent_infra/runtime/logs/ipc", hours: int = 24) -> Dict[str, Any]:
    """扫描 IPC 日志文件，统计消息"""
    stats = {
        'total_messages': 0,
...
def main():
    ...
    parser.add_argument('--log-dir', type=str, default='/xkagent_infra/runtime/logs/ipc', help='IPC log directory')
