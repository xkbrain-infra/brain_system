...
metadata:
  ...
  publish_target: /xkagent_infra/brain/base/skill/project-delivery
---
...
- hooks: `/xkagent_infra/groups/brain/projects/base/hooks/overrides/project-delivery`

发布说明：
- project 侧完成设计后，发布到 `/xkagent_infra/brain/base/skill/project-delivery`
