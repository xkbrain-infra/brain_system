...
```json
{
  "status": "ok",
  "msg_id": "a3f8c2d14e91",
  "to": "agent_system_dev@brain_system:%5",
  "conversation_id": "conv-abc123",
...
```json
{
  ...
  "data": {
    "participants": "agent_system_pmo,agent_system_dev",
...
**响应：**
```json
{"status": "ok", "conversation_id": "conv-a1b2c3d4", "participants": "agent_system_pmo,agent_system_dev"}
```
...
示例：`agent_system_dev@brain_system:%5`

`to` 字段接受三种格式：
1. 逻辑名：`"agent_system_dev"`
2. 完整 instance_id：`"agent_system_dev@brain_system:%5"`
