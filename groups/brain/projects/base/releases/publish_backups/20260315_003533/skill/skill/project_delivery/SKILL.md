...
**路径**: `/brain/base/workflow/project_delivery`
...
| 文档 | 路径 |
|------|------|
| Workflow Index | `/brain/base/workflow/project_delivery/index.yaml` |
| SPEC_CHECKLIST | `/brain/base/workflow/project_delivery/SPEC_CHECKLIST.yaml` |
| Checklist Template | `/brain/base/workflow/project_delivery/spec_checklist.instance.template.yaml` |
| State Machines | `/brain/base/workflow/project_delivery/contracts/state_machines.yaml` |
| Execution Contract | `/brain/base/workflow/project_delivery/contracts/execution_contract.yaml` |
| Release Contract | `/brain/base/workflow/project_delivery/contracts/release_contract.yaml` |
| Audit Contract | `/brain/base/workflow/project_delivery/contracts/audit_contract.yaml` |

## Workflow 入口文件

| 阶段 | 文件 |
|------|------|
| intake | `/brain/base/workflow/project_delivery/intake.yaml` |
| research | `/brain/base/workflow/project_delivery/research.yaml` |
| bootstrap | `/brain/base/workflow/project_delivery/bootstrap.yaml` |
| planning | `/brain/base/workflow/project_delivery/planning.yaml` |
| task-modeling | `/brain/base/workflow/project_delivery/task_modeling.yaml` |
| execution | `/brain/base/workflow/project_delivery/execution.yaml` |
| release | `/brain/base/workflow/project_delivery/release.yaml` |
| audit | `/brain/base/workflow/project_delivery/audit.yaml` |
