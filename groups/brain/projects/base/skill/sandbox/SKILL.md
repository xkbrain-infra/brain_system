...
```bash
# 源代码路径 (base 项目)
SANDBOX_SOURCE="/xkagent_infra/groups/brain/projects/base/sandbox"
# 运行时数据路径 (platform 目录)
SANDBOX_RUNTIME="/xkagent_infra/groups/brain/platform/sandbox"
# 服务脚本
SANDBOX_SERVICE="python3 ${SANDBOX_SOURCE}/service/sandbox_service.py"
```
