---
id: G-SKILL-DEPLOY-BRAIN-IMAGE-PUBLISH
name: brain-image-publish
...
metadata:
  ...
  publish_target: /xkagent_infra/brain/base/skill/brain-image-publish
---
...
| 需要先决定正式版本号 | → 先使用 `/brain-release` |
| 只是 base skill/spec/workflow 发布 | → 使用 `/brain-publish` |
