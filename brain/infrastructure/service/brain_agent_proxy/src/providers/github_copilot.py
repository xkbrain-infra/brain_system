            ...
            prepared.append(
                {
                    ...
                    "function": {
                        ...
                        "parameters": self._sanitize_tool_schema(
    ...
    async def forward(self, request: Dict[str, Any], protocol: str = "chat_completions") -> Dict[str, Any]:
        ...
        if protocol == "messages":
            ...
            if resp.status_code in (400, 404):
                ...
                alias_to_original = payload.pop("_tool_alias_map", {})
                ...
                if chat_resp.status_code == 200:
                    ...
                    return result
                self._dump_failed_request(payload, "chat_completions", chat_resp.text)
        ...
        result = resp.json()
        self._restore_tool_aliases_in_response(result, request.pop("_tool_alias_map", {}))
        return result
            ...
            async with httpx.AsyncClient(timeout=None) as client:
                async with client.stream("POST", url, json=payload, headers=headers) as resp:
                    ...
                    if resp.status_code != 200:
                        ...
                        self._dump_failed_request(payload, protocol, body)
