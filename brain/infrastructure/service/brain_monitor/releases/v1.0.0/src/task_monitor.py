...
def scan_timer_logs(log_dir: str = "/brain/runtime/logs/timer", hours: int = 24) -> Dict[str, Any]:
...
def main():
    ...
    parser.add_argument('--log-dir', type=str, default='/brain/runtime/logs/timer', help='Timer log directory')
