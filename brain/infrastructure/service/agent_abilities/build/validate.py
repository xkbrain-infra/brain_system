...
def main():
    ...
    spec_dir_real = spec_dir.resolve()
    is_src = str(spec_dir_real) != "/brain/base/spec"
    ...
    checks = [
        ("Registry paths exist", lambda: check_paths_exist(documents, spec_dir_real, is_src)),
        ...
        ("YAML syntax", lambda: check_yaml_syntax(spec_dir_real)),
        ("Orphan files", lambda: check_orphan_files(documents, spec_dir_real, is_src)),
    ]
