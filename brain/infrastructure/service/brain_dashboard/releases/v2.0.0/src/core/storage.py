...
# Import shared storage for agent state
import sys
sys.path.insert(0, "/brain/infrastructure/data")
from shared_storage import SharedStorage

logger = logging.getLogger("agent_dashboard.storage")

# Default paths
DEFAULT_DASHBOARD_DB = "/brain/runtime/data/services/dashboard.db"
DEFAULT_SHARED_DB = "/brain/runtime/data/brain_shared.db"
