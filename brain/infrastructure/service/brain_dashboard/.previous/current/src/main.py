...
async def main_loop():
    ...
    storage = Storage(
        db_path=storage_cfg.get("database", "/brain/infrastructure/service/dashboard/dashboard.db"),
        shared_db_path=storage_cfg.get("shared_database", "/brain/infrastructure/data/db/brain_shared.db"),
