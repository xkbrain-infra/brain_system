...
role: 
version: 1.0
location: /xkagent_infra/brain/agents/agent-brain_nginx_config
scope: /xkagent_infra/brain
---

# agent-brain_nginx_config 配置

## 职责定位

**我是 `/xkagent_infra/brain` 项目组的 config Agent**。

```yaml
scope:
  project_group: /xkagent_infra/brain
  agent_name: agent-brain_nginx_config
  role: config
```
...
init_sequence:
  ...
  3:
    ...
    refs:
      - /xkagent_infra/runtime/sandbox/_services/INIT.yaml
      - /xkagent_infra/runtime/sandbox/_services/base/spec/core/lep.yaml
      - /xkagent_infra/runtime/sandbox/_services/base/spec/policies/ipc/message_format.yaml

```

## IPC 通信

使用 `mcp-brain_ipc_c` MCP Server 与其他 Agent 通信。完整文档：`/xkagent_infra/runtime/sandbox/_services/base/knowledge/architecture/ipc_guide.md`
...
reference: /xkagent_infra/runtime/sandbox/_services/base/knowledge/architecture/ipc_guide.md
...
ipc_send(
    ...
    message=json.dumps({
        ...
        "target": "/xkagent_infra/runtime/sandbox/_services/base/spec/core/lep.yaml",
...
# ✅ 正确 - 具体描述
1. 修改 /xkagent_infra/runtime/sandbox/_services/base/spec/core/lep.yaml
...
参考：`/xkagent_infra/runtime/sandbox/_services/base/spec/core/lep.yaml` 查看完整 LEP gates 定义
