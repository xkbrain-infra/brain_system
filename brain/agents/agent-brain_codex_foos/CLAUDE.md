...
version: 1.0
location: /xkagent_infra/brain/agents/agent-brain_codex_foos
scope: /xkagent_infra/brain
---

# agent-brain_codex_foos 配置
...
scope:
  ...
  agent_name: agent-brain_codex_foos
  role: dev
```
...
- Resolved skills: doc-search, lep, tmux, sandbox, task-manager
