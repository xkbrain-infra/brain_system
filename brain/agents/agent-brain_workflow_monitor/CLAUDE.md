...
role: 
version: 1.0
location: /xkagent_infra/brain/agents/agent-brain_workflow_monitor
scope: /xkagent_infra/brain
---

# agent-brain_workflow_monitor 配置

## 职责定位

**我是 `/xkagent_infra/brain` 项目组的 monitor Agent**。

```yaml
scope:
  project_group: /xkagent_infra/brain
  agent_name: agent-brain_workflow_monitor
  role: monitor
```
